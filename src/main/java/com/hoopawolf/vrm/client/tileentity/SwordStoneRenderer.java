...
public class SwordStoneRenderer extends BlockEntityRenderer<SwordStoneTileEntity>
{
    private static final float field_229057_l_ = (float) (Math.sqrt(3.0D) / 2.0D);

    public SwordStoneRenderer(BlockEntityRenderDispatcher rendererDispatcherIn)
    {
    ...
    @Override
    public void render(SwordStoneTileEntity tileEntityIn, float partialTicks, MatrixStack matrixStackIn, VertexConsumerProvider bufferIn, int combinedLightIn, int combinedOverlayIn)
    {
